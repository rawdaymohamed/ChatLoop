      ...
      <div className="relative z-10 flex h-full flex-col items-center justify-center overflow-y-auto px-4 py-10">
        <div className="flex w-full max-w-100 flex-col gap-6">
          ...
          <div className="flex flex-col items-center gap-3 text-center">
            ...
            <div>
              <h1 className="text-5xl leading-none font-bold tracking-tight text-foreground">
                ChatLoop
              </h1>
          ...
          {/* Form card */}
          <Card className="rounded-2xl border border-border/60 bg-card p-6 shadow-xl shadow-black/5 dark:shadow-black/25">
            <div className="mb-5">
              ...
              <TabsContent value="password">
                <form onSubmit={handlePasswordLogin} className="space-y-4">
                  ...
                  <Button
                    ...
                    disabled={pwLoading}
                  >
                    {pwLoading ? <Spinner className="mr-2 h-4 w-4" /> : null}
                  ...
                  {!otpSent ? (
                    <form onSubmit={handleSendOtp} className="space-y-4">
                      ...
                      <p className="text-xs text-muted-foreground">
                        We'll send a one-time password to your email. Valid for
                        5 minutes.
                      </p>
                      <Button
                        type="submit"
                    ...
                    <form onSubmit={handleOtpLogin} className="space-y-4">
                      ...
                      <div className="flex items-center justify-between text-xs">
                        ...
                        <button
                          ...
                          className="flex items-center gap-1 transition-opacity hover:opacity-80 disabled:opacity-40"
                        >
